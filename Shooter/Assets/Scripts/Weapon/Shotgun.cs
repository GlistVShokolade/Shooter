...
public class Shotgun : Weapon, IAttackBehavier, IAmmoBehavier
{
    ...
    private void Start()
    {
        Attack = new ShotgunAttack(_damage, _rate, _distance, _shootCount, _spreadFactor, _spendType, _cameraTransform, Ammo);
    }
